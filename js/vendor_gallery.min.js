...
if(sd>settings.min){$toTop.fadeIn(settings.fade_in);}else{$toTop.fadeOut(settings.fade_out);}});};$('body').DynamicToTop();})(jQuery,mv_dynamic_to_top);jQuery(function($){'use strict';var _Blog=window._Blog||{};_Blog.prettify=function(){$('pre').addClass('prettyprint linenums').attr('style','overflow:auto;');$('pre > code[class^="language-"]').each(function(){$(this).parent().addClass("codewithlang");$(this).parent().attr("data-lang",this.className.substring(9));if(this.className=="language-text")$(this).parent().addClass("nocode");});window.prettyPrint&&prettyPrint();};_Blog.externalUrl=function(){$.expr[':'].external=function(obj){return!obj.href.match(/^mailto\:/)&&(obj.hostname!=location.hostname);};$('a:external').addClass('external');$(".external").attr('target','_blank');}
